...
[![Backend Tests](https://github.com/marfebr/portal-uft/actions/workflows/backend.yml/badge.svg)](https://github.com/marfebr/portal-uft/actions/workflows/backend.yml)
[![Frontend Tests](https://github.com/marfebr/portal-uft/actions/workflows/frontend.yml/badge.svg)](https://github.com/marfebr/portal-uft/actions/workflows/frontend.yml)
...
```shell
git clone git@github.com:marfebr/portal-uft.git
cd portal-uft
make install
```
...
**This was generated by [cookiecutter-plone-starter](https://github.com/collective/cookiecutter-plone-starter) on 2022-06-22 17:11:44**
